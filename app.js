...
var TIPO=null, MODO='nuevo', GEN={loc:'m',loc2:'m'}, GARS=[], GC=0, CLO={}, CLE={};
...
async function genWord(){
  try {
    ...
    c+=wL();
    c+=wP(lG.el+'/la '+lG.sr+'/Sra. '+v('loc-n')+', DNI:'+v('loc-d')+', '+v('loc-nac')+', mayor de edad, '+lG.nacido+' el '+fL(v('loc-fn'))+', por una parte y en adelante tambien llamado "El Locador", y por la otra '+l2G.el+'/la '+l2G.sr+'/Sra. '+v('loc2-n')+', DNI: '+v('loc2-d')+', '+v('loc2-nac')+', mayor de edad, '+l2G.nacido+' el '+fL(v('loc2-fn'))+' en adelante tambien llamada "El Locatario", se ha convenido en celebrar el siguiente contrato de locacion de inmueble que se regira por las siguientes clausulas:');
